...
$error="Lo siento intentelo mas tarde";	
}
}
?>
...
<html>
<head>
<title> Contraseña de cambio de administrador</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Perfil <i class="fa fa-angle-right"></i> Cambia la contraseña</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
