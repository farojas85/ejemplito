...
<html>
<head>
<title>Dashboard de el wado </title>
...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Clientes</h3>
										<?php $sql1 = "SELECT id_cliente from clientes";
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Comentarios</h3>
												<?php $sql2 = "SELECT id from tblconsultas";
						...
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Total de platos</h3>
																	<?php $sql3 = "SELECT Platoid from tblplatos";
						...
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Delivery Rapido</h3>
												<?php $sql5 = "SELECT id from tblpeticion";
...
$cnt5=$query5->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								<h3>Delivery de usuarios</h3>
												<?php $sql6 = "SELECT id from tblreserva";
...
$cnt6=$query6->rowCount();
					?>
						...
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Pedidos</h3>
												<?php $sql7 = "SELECT idpedidos from tblpedidos";
$query7= $dbh -> prepare($sql7);
$query7->execute();
$results7=$query7->fetchAll(PDO::FETCH_OBJ);
$cnt7=$query7->rowCount();
					?>
								<h4><?php echo htmlentities($cnt7);?></h4>
