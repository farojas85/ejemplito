...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Ttusolutionweb |  sistema de gestión del turismo</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<p style="width: 350px;">
<b>ultima fecha de actualización : </b>
...
<?php }} ?>
			...
			<p style="width: 350px;">
<button type="submit" name="submit6" class="btn-primary btn">Actualizado</button>
			</p>
			</form>
